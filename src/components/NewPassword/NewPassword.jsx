    ...
    return (
        <>
            ...
            <form onSubmit={myForm.handleSubmit} className="max-w-lg mx-auto mt-5">
                ...
                <h2 className='text-2xl mb-5 text-[--main-color] font-bold'>New Password :</h2>
                <div className="mb-5">
                ...
                <div className="mb-5">
                    ...
                    <input onChange={myForm.handleChange} onBlur={myForm.handleBlur} value={myForm.values.password} type="password" name="newPassword" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="New Password" />
                </div>

                {myForm.errors.newPassword && myForm.touched.newPassword ? <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
